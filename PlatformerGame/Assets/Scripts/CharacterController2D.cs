...
public class CharacterController2D : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        Collider2D[] hits = Physics2D.OverlapBoxAll(transform.position + new Vector3(0, -0.35f,0)
            , new Vector3(0.5f, 0.1f, 0f), _layerMask);
        bool isGround = false;
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.gameObject.CompareTag("Item")) {
            ...
            RuntimeGameDataManager.instance.AddCount(1);
        }
